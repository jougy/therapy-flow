...
describe("support contact helpers", () => {
  ...
  it("builds a mailto href with encoded subject and context", () => {
    ...
    expect(href).toContain("subject=%5BPluri-Health%5D%20Erro%20-%20Tela%20de%20configuracoes%20com%20falha");
  ...
  it("builds a WhatsApp url with a compact support message", () => {
    ...
    expect(decodeURIComponent(href)).toContain("[Pluri-Health] Melhoria");
