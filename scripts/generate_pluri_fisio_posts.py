...
WORKSPACE = "/Users/jougy/Documents/therapy-flow"
OUT_DIR = os.path.join(WORKSPACE, "public/branding/social/pluri_fisio")
os.makedirs(OUT_DIR, exist_ok=True)

LOGO_PATH = os.path.join(WORKSPACE, "public/branding/logo/pluri_health_logo_gradient.png")
with open(LOGO_PATH, "rb") as f:
    logo_b64 = base64.b64encode(f.read()).decode("utf-8")

# ==========================================
# POST 1: "Conheça o Pluri Fisio: pensado para a maca e para sua rotina"
# iPad Mockup com UI Real do Projeto (Amanda Costa, LCA Joelho, Escala EVA, SOAP Completo)
# ==========================================
post1_svg = f"""<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1080" viewBox="0 0 1080 1080">
  <defs>
  ...
  <g transform="translate(540, 110)">
    <image href="data:image/png;base64,{logo_b64}" x="-50" y="-75" width="100" height="100" />
...
with open(os.path.join(OUT_DIR, "post1_pluri_fisio_real.svg"), "w", encoding="utf-8") as f:
    f.write(post1_svg.strip())

# ==========================================
# POST 2: "Tudo o que você precisa em um só lugar"
# 3 Módulos Reais: Prontuário & SOAP | Gráficos de Anamnese | Controle de Pacotes
# ==========================================
post2_svg = f"""<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1080" viewBox="0 0 1080 1080">
  <defs>
  ...
  <g transform="translate(540, 95)">
    <image href="data:image/png;base64,{logo_b64}" x="-45" y="-70" width="90" height="90" />
...
with open(os.path.join(OUT_DIR, "post2_tudo_em_um_so_lugar_real.svg"), "w", encoding="utf-8") as f:
    f.write(post2_svg.strip())

# ==========================================
# POST 3: "Acabe com o abandono de tratamento e faltas de pacientes"
# Destaque: Pacotes Ativos, Alertas de Renovação e Pílula Semanal Anti-Falta
# ==========================================
post3_svg = f"""<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1080" viewBox="0 0 1080 1080">
  <defs>
    ...
    <filter id="cardShadow3" x="-10%" y="-10%" width="120%" height="120%">
      <feDropShadow dx="0" dy="18" stdDeviation="24" flood-color="#16a34a" flood-opacity="0.14" />
  ...
  <!-- Ambient light glows -->
  <circle cx="950" cy="150" r="280" fill="#dcfce7" opacity="0.6" />
  <circle cx="100" cy="950" r="280" fill="#e0f2fe" opacity="0.4" />
  ...
  <g transform="translate(540, 215)">
    <text x="0" y="0" text-anchor="middle" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="900" font-size="44" fill="#0f172a" letter-spacing="-0.5">
      Faltas de pacientes e descontrole de pacotes?
    </text>
    <text x="0" y="54" text-anchor="middle" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-weight="900" font-size="44" fill="#16a34a" letter-spacing="-0.5">
      Nunca mais na sua clínica.
    </text>
  </g>

  <!-- Central Real Dashboard Showcase -->
  <g transform="translate(140, 330)" filter="url(#cardShadow3)">
    <!-- Container Base -->
    <rect width="800" height="540" rx="24" fill="#ffffff" stroke="#e2e8f0" stroke-width="1.5" />

    <!-- Top Status Bar -->
    <rect x="0" y="0" width="800" height="60" rx="24" fill="#f8fafc" />
    <line x1="0" y1="60" x2="800" y2="60" stroke="#e2e8f0" stroke-width="1" />
    
    <g transform="translate(24, 35)">
      <circle cx="10" cy="0" r="6" fill="#10b981" />
      <text x="24" y="5" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="800" font-size="15" fill="#0f172a">Módulo de Retenção &amp; Pacotes Recorrentes</text>
    </g>

    <g transform="translate(640, 35)">
      <rect x="-10" y="-14" width="145" height="28" rx="14" fill="#dcfce7" />
      <text x="62" y="5" text-anchor="middle" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="700" font-size="12" fill="#15803d">✓ 0% Abandono</text>
    </g>

    <!-- Main Content Inside the Showcase -->
    <g transform="translate(30, 80)">
      <!-- Metric Cards (Real Stats) -->
      <g transform="translate(0, 0)">
        <!-- Metric 1 -->
        <rect width="230" height="90" rx="12" fill="#f8fafc" stroke="#e2e8f0" stroke-width="1" />
        <text x="16" y="28" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="600" font-size="12" fill="#64748b">Pacotes Ativos</text>
        <text x="16" y="62" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="800" font-size="28" fill="#0f172a">42</text>
        <text x="75" y="60" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="700" font-size="12" fill="#16a34a">+8 este mês</text>

        <!-- Metric 2 -->
        <g transform="translate(255, 0)">
          <rect width="230" height="90" rx="12" fill="#fef2f2" stroke="#fecaca" stroke-width="1" />
          <text x="16" y="28" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="600" font-size="12" fill="#991b1b">Taxa de No-Show (Faltas)</text>
          <text x="16" y="62" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="800" font-size="28" fill="#dc2626">2.4%</text>
          <text x="100" y="60" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="700" font-size="12" fill="#15803d">↓ Redução de 85%</text>
        </g>

        <!-- Metric 3 -->
        <g transform="translate(510, 0)">
          <rect width="230" height="90" rx="12" fill="#f0fdf4" stroke="#bbf7d0" stroke-width="1" />
          <text x="16" y="28" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="600" font-size="12" fill="#166534">Taxa de Renovação</text>
          <text x="16" y="62" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="800" font-size="28" fill="#15803d">94%</text>
          <text x="100" y="60" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="700" font-size="12" fill="#166534">Alta adesão</text>
        </g>
      </g>

      <!-- Two Large Functional Rows -->
      <!-- Row 1: Paciente prestes a encerrar + WhatsApp automático -->
      <g transform="translate(0, 110)">
        <rect width="740" height="145" rx="14" fill="#ffffff" stroke="#e2e8f0" stroke-width="1.2" />
        
        <g transform="translate(20, 24)">
          <circle cx="22" cy="22" r="22" fill="#e0f2fe" />
          <text x="22" y="28" text-anchor="middle" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="700" font-size="14" fill="#0284c7">BS</text>
          
          <text x="56" y="18" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="800" font-size="15" fill="#0f172a">Bruno Souza</text>
          <text x="56" y="36" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="500" font-size="12" fill="#64748b">Plano: Pilates Clínico &amp; Coluna • 9 de 10 sessões realizadas</text>

          <rect x="490" y="4" width="200" height="30" rx="8" fill="#fef3c7" stroke="#fde68a" stroke-width="1" />
          <text x="590" y="24" text-anchor="middle" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="700" font-size="12" fill="#b45309">⚠️ Renovação Necessária</text>

          <!-- Progress Bar -->
          <rect x="0" y="58" width="500" height="8" rx="4" fill="#e2e8f0" />
          <rect x="0" y="58" width="450" height="8" rx="4" fill="#f59e0b" />

          <text x="515" y="66" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="700" font-size="12" fill="#b45309">90% concluído</text>

          <!-- WhatsApp Trigger Button -->
          <g transform="translate(0, 80)">
            <rect width="250" height="32" rx="8" fill="#25d366" />
            <text x="125" y="21" text-anchor="middle" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="700" font-size="12" fill="#ffffff">📲 Enviar Lembrete no WhatsApp</text>
          </g>

          <text x="270" y="101" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="500" font-size="11" fill="#64748b">Mensagem personalizada de renovação gerada em 1 clique.</text>
        </g>
      </g>

      <!-- Row 2: Pílula Semanal de Recorrência (Elimina no-show) -->
      <g transform="translate(0, 275)">
        <rect width="740" height="150" rx="14" fill="#f8fafc" stroke="#e2e8f0" stroke-width="1.2" />
        
        <g transform="translate(20, 20)">
          <text x="0" y="16" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="800" font-size="15" fill="#0f172a">Pílula Semanal de Presença (Frequência Fixa)</text>
          <text x="0" y="34" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="500" font-size="12" fill="#64748b">O paciente tem horários cativos na agenda, evitando cancelamentos de última hora.</text>

          <!-- Weekly Days Component (Real Code Style) -->
          <g transform="translate(0, 50)">
            <!-- Pill background -->
            <rect width="400" height="42" rx="21" fill="#ffffff" stroke="#cbd5e1" stroke-width="1.2" />
            
            <text x="30" y="26" font-family="monospace" font-weight="600" font-size="14" fill="#94a3b8">DOM</text>
            
            <!-- SEG (Active) -->
            <circle cx="95" cy="21" r="16" fill="#0284c7" />
            <text x="95" y="26" text-anchor="middle" font-family="monospace" font-weight="700" font-size="13" fill="#ffffff">SEG</text>

            <text x="150" y="26" font-family="monospace" font-weight="600" font-size="14" fill="#94a3b8">TER</text>

            <!-- QUA (Active) -->
            <circle cx="215" cy="21" r="16" fill="#0284c7" />
            <text x="215" y="26" text-anchor="middle" font-family="monospace" font-weight="700" font-size="13" fill="#ffffff">QUA</text>

            <text x="270" y="26" font-family="monospace" font-weight="600" font-size="14" fill="#94a3b8">QUI</text>

            <!-- SEX (Active) -->
            <circle cx="335" cy="21" r="16" fill="#0284c7" />
            <text x="335" y="26" text-anchor="middle" font-family="monospace" font-weight="700" font-size="13" fill="#ffffff">SEX</text>

            <text x="385" y="26" font-family="monospace" font-weight="600" font-size="14" fill="#94a3b8">SAB</text>
          </g>

          <g transform="translate(430, 52)">
            <rect width="270" height="38" rx="8" fill="#dbeafe" />
            <text x="135" y="24" text-anchor="middle" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="700" font-size="12" fill="#1d4ed8">🕒 3x por semana • 08:00h</text>
          </g>
        </g>
      </g>
    </g>
  ...
  <g transform="translate(540, 925)">
    <text x="0" y="0" text-anchor="middle" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="700" font-size="16" fill="#0f172a">
      Controle de Pacotes • Pílula Semanal • Disparo WhatsApp • Gestão Financeira
    </text>
    <text x="0" y="30" text-anchor="middle" font-family="-apple-system, BlinkMacSystemFont, sans-serif" font-weight="600" font-size="14" fill="#16a34a">
      pluri.health ↗
    </text>
  </g>
</svg>"""

with open(os.path.join(OUT_DIR, "post3_pacotes_recorrencia_real.svg"), "w", encoding="utf-8") as f:
    f.write(post3_svg.strip())

print("All 3 real SVG posts created successfully!")
